...
export const MOVES = {
  // --- stoot-keten (A A A) ---------------------------------------------------
  jab: {
    dur: 0.24, hitFrom: 0.30, hitTo: 0.52, reach: 1.4, dmg: 1, limb: 'armR',
    knockback: 0.35, hitstop: 0.07, chainFrom: 0.42, chainTo: 0.95, chainsTo: 'cross',
  ...
  cross: {
    dur: 0.34, hitFrom: 0.32, hitTo: 0.55, reach: 1.5, dmg: 1, limb: 'armL',
    knockback: 0.6, hitstop: 0.09, chainFrom: 0.46, chainTo: 0.95, chainsTo: 'backfist',
  ...
  backfist: {
    dur: 0.5, hitFrom: 0.42, hitTo: 0.62, reach: 1.7, dmg: 2, limb: 'armR',
  ...
  // --- trap-keten (B B B) ----------------------------------------------------
  frontkick: {
    dur: 0.4, hitFrom: 0.36, hitTo: 0.58, reach: 1.8, dmg: 1, limb: 'legR',
    knockback: 1.0, hitstop: 0.09, chainFrom: 0.5, chainTo: 0.95, chainsTo: 'roundhouse',
  ...
  roundhouse: {
    dur: 0.52, hitFrom: 0.4, hitTo: 0.6, reach: 1.9, dmg: 2, limb: 'legL',
    knockback: 1.6, hitstop: 0.12, heavy: true, chainFrom: 0.55, chainTo: 0.95, chainsTo: 'tornado',
  ...
  tornado: { // 540-achtige spinkick: de finisher-kandidaat van de keten
    dur: 0.7, hitFrom: 0.5, hitTo: 0.7, reach: 2.0, dmg: 3, limb: 'legR',
